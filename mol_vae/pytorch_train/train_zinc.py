...
def load_data():
    ...
    if len(all_true_binary) > 10000:
        return all_true_binary[10000:], all_rule_masks[10000:], all_true_binary[5000:10000], all_rule_masks[5000:10000]
    return all_true_binary, all_rule_masks, all_true_binary, all_rule_masks
